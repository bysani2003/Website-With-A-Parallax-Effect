...
function displayLogoQuestion(){
    ...
    if (quiz3.isEnded()) {
        ...
        let questionElement = document.getElementById("qn");
        questionElement.innerHTML = `<img src='${quiz3.getQuestionIndex().text}' 
        style='width:30%; height:70%; display:flex; margin-left:auto; margin-right:auto'></img>`;
...
function QuizNumber(Count){
    ...
    quizNumber.innerHTML = `Section ${Count}`;
}
...
let questions1 = [
    new Question(
        "From which among the following parts of a plant Cinnamon is obtained?", ["Leaves", "Seeds", "Bark", "Buds"], "Bark"
    ),
    new Question(
        "Which among the following is not present in pure sugar ? ", 
        ["Carbon", "Hydrogen", "Nitrogen", "Oxygen"], "Nitrogen"
    ),
    new Question(
        "Which among the following is not correctly matched?", ["Malleus – Middle Ear Bone", " Maxilla – Cranial Bone", "Lunate Carpal Bone", "All are corrrect"], "Maxilla – Cranial Bone"
    ),
    new Question(
        "Which among the following plants is known as Indian ginseng?", [" Withania somnifera", " Datura ceratocaula", "Iberis amara", "Vacuoles"], "Withania somnifera"
    ),
    new Question(
        "Which among the following group represents the most commonly found cancers in the world?", [" Carcinoma", "Sarcoma", " Lymphoma", "Dedanucleic acid"], "Deoxyribonucleic acid"
    ),
    new Question(
...
let questions3 = [
    new Question(
        "images/spacex_img.jpg", ["Hammer", "SpaceX", "Texas", "Pinnacle"], "SpaceX"
    ),
    new Question(
        "images/boa.png", ["DBS Bank", "Bank Of Netherlands", "Citi Bank", "Bank Of America"], "Bank Of America"
    ),
    new Question(
        "images/meta.png", ["Meta ", "Twitter", "Instagram  ", "Google"], "Meta"
    ),
    new Question(
        "images/blockchain.png", ["Bitcoin", "Etherum", "Doge Coin", "Sweep Coin"], "Bitcoin"
    ),
    new Question(
        "images/zoom.png", ["Gmeet", "Zoom", "Instagram", "Facebook"], "Zoom"
    )
];
